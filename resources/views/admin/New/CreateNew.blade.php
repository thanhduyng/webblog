    ...
    <div class="col-xs-12">
        <form class="form-horizontal" id="formDetail" role="form" action="{{route('InsertNew')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="file" placeholder="nhập link ảnh đại diện" name="background_image" id="files" value="{{$data->background_image}}"class="col-xs-10 col-sm-5" />
                </div>
            </div>
            ...
            <div class="form-group" id="divImage">
                ...
                <div class="col-sm-9">
                    <input type="file" placeholder="nhập link ảnh" id="filImage[]" name="filImage[]" required="" class="col-xs-10 col-sm-5">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
