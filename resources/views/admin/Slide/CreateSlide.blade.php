    ...
    <div class="col-xs-12">
        <form class="form-horizontal" id="formDetail" role="form" action="{{route('InsertSlide')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <span class="dashicons dashicons-nametag"></span> Tên Slide</label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    @if(isset($data->image))
                    <img src="/upload/slides/{{ $data->image }}" height="150px">
                    @endif
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> Thứ tự </label>
                <div class="col-sm-9">
