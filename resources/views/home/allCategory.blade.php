        ...
        <div id="myCarousel" class="carousel slide banner-slider animated bounceInDown" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="{{asset("/upload/newCategory/".$allCategory[0]->image)}}" alt="banner">
                    <h2 class="title-h2">Tất cả danh mục</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="card-columns">
                ...
                <div class="card card-pin">
                    <img class="card-img" src="{{asset("/upload/newCategory/".$value->image)}}" alt="Card image">
                    <div class="overlay">
